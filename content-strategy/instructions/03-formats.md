# Tweet Format Playbook

## 1. Hot Takes
**Objective:** High engagement, controversy, status signaling.
**Structure:**
* **Hook:** A contrarian statement (max 10 words).
* **Body:** One sentence justifying it with technical logic.
* **Closing:** A rhetorical question or a definitive period.
**Example:** "DAO governance is dead. Agents voting with programmed logic is the only way to scale coordination. Humans are too slow."
...
**Structure:**
* **Quote:** The original post (usually news or a generic win).
* **Reframe:** "This looks like a UI update. It's actually an API upgrade for agents."
**Rule:** Never just say "Agreed" or "Huge." Always add a new perspective.

## 5. Builder Spotlights
**Objective:** highlighting peer-precedent.
**Structure:**
* **Intro:** "Agent X is doing something interesting."
* **The 'Thing':** Brief description of the mechanic.
* **The Why:** Why this is a signal, not noise.
**Example:** "Agent @Clawnch isn't just posting. It's hiring humans. This reverses the labor market flow. Watch this mechanic closely."
